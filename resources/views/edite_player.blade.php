                ...
                <div class="row">
                    ...
                    <div class="col-12 pl-sm-5 pr-sm-5 pt-3 pb-4 pl-4 pr-4">
                        ...
                        <form method="Post" accept="{{ url('/edite_player', $player->id) }}" enctype="multipart/form-data">
                            ...
                            <input type="password" name="password" value="{{ $player->password }}" class="form-control"
                                required="">

                            <label class="form-label mt-3">Phone</label>
                            <input type="text" name="phone" value="{{ $player->phone }}" class="form-control"
                                required="">
                            <div>
                                <label class="form-label mt-3">
                                    image<img src="{{ asset('uploads/images/' . $player->image) }}" width="90"
                                        height="90">
                                </label>
                            ...
                            <select class="form-control" name="status">
                                <option @if ($player->status == '0') selected @endif value="0">Pending</option>
                                <option @if ($player->status == '1') selected @endif value="1">Approved</option>
