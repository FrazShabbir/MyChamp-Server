...
@section('main-section')
   	<div class="row">
        ...
        <a href="{{url('/add_player')}}">
          <button class="btn text-white mb-4" style="background: #4675A9">Add Player</button>
        </a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> 
                        ...
                        <a href="" data-id="<?= $row['id'] ?>" data-toggle="modal" data-target="#exampleModal1" class="btn btn-success   
                    ...
                    <td>
                      <a href="{{url('/edite_player' , $row->id)}}">
                ...
                @endforeach
                  ...
                  <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content">
                          <div class="modal-body">
                              <h6>Are you sure you want to change Player status?</h6>
                              <p style="font-size: 12px;">This action cannot be undone, proceed?</p>
